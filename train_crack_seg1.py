...
class Trainer1:
    ...
    def load_model(self):
        ...
        if torch.cuda.is_available():
            ...
            if get_memory < 4:
                ...
                print("GPU内存较小,调整批次为8")
            elif get_memory < 8:
                self.train_config["batch"] = 12
                print("GPU内存中等,调整批次为12")
            else:
                self.train_config["batch"] = 16
                print("GPU内存较大,调整批次为16")
    ...
    def print_train_summary(self):
        ...
        try:
            ...
            # 打印最终指标 - 添加安全检查
            if results_dict.get("metrics/mAP50(B)"):
            ...
            if results_dict.get("metrics/mAP50-95(B)"):
            ...
            if results_dict.get("metrics/mAP50(M)"):
            ...
            if results_dict.get("metrics/mAP50-95(M)"):
            ...
            # 打印最终损失
            if results_dict.get("train/box_loss"):
            ...
            if results_dict.get("train/seg_loss"):
